...
let signup_file = (course, name, identification) => {
   ...
   if(subject == undefined) {
      /* let res = document.getElementById('results__area')
      res.innerHTML = 'No es posible realizar la inscripcion' */
   ...
   /* Shows result in a tab in the browser */
...
let show_courses = () => {
   ...
   for(let i = 0; i < courses.length; i++) {
      setTimeout(function() {
         ...
         console.log(info)
         //document.getElementById('results__area').innerHTML = info
      }, i * 2000);
   };
};
